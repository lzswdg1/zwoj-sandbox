...
import com.zw.zwojcodesandbox.model.JudgeInfo;
import com.zw.zwojcodesandbox.utils.ProcessUtils;
...
//        String compileCmd = String.format("javac -encoding utf-8 %s", userCodeFile.getAbsolutePath());
        // 增加 -source 1.8 -target 1.8 参数，强制生成兼容 Java 8 的 class 文件
...
//    }
    ...
    public List<ExecuteMessage> runFile(File userCodeFile, List<String> inputList) {
        ...
        List<ExecuteMessage> executeMessageList = new ArrayList<>();
        for (String inputArgs : inputList) {
            // 【修改点1】：注意这里去掉了结尾的 %s，不通过命令行传参，而是通过流输入
            ...
            try {
                ...
                // 【修改点2】：使用 runInteractProcessAndGetMessage (交互式)，它会向 System.in 写入数据
                // 之前的代码是: ExecuteMessage executeMessage = ProcessUtils.runProcessAndGetMessage(runProcess, "运行");
